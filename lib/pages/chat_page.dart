...
import 'package:minimal_app/components/chat_bubble.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  final ScrollController _scrollContronller = ScrollController();

  void scrollDown() {
    _scrollContronller.animateTo(
      _scrollContronller.position.maxScrollExtent,
